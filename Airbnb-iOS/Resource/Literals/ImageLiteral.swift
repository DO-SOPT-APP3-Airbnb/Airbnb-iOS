...
//  Airbnb-iOS
//
//  Created by 지희의 MAC on 2023/11/18.
//

import UIKit

class ImageLiteral {
    static let icExploreBtmMessage = UIImage(named: "ic_explore_btm_message")!
    static let icExploreBtmProfile = UIImage(named: "ic_explore_btm_profile")!
